 ...
 */
public class UWIssueSCHO3 extends BaseTest {
    ...
    public void CreatesAccountandValdatingSCUWIssue(ITestContext itc) {
        ...
        SCHO3DwellingConstruction dwellingConstruction = dwe.next();


        SCHO3Coverages coverages = dwellingConstruction.clickWindMitigation()
        ...
        SCHO3UWActivity uwa = ra.riskAnalysisRequestApproval();
