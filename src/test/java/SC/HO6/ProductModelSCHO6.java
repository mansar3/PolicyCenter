...
//        String lastname = "Bobby0209015449";
        ...
        boolean specificOtherStructures = false;
        Boolean scheduledPersonalProperty = false;
        ...
        SCHO6SearchAccounts sa = nb.clickSearchAccount();
        SCHO6AccountFileSummary afs = sa.setFirstName(firstname)
                .setLastName(lastname)
                .clickSearchButton()
