 ...
 */
public class UWIssueSCHO6 extends BaseTest {
    ...
    public void CreatesAccountandValdatingFLUWIssue(ITestContext itc) {
        ...
        SCHO6Dwelling dwe = pi.setEffectiveDate(priorDate)
                .next()
                .setYearBuilt(yearBuilt)
                .setDistanceToFireHydrant(distanceToFireHydrant);

        SCHO6DwellingConstruction dwellingConstruction = dwe.next();


        SCHO6Coverages coverages = dwellingConstruction.clickWindMitigation()
        ...
        SCHO6UWActivity uwa =  ra.riskAnalysisRequestApproval();
