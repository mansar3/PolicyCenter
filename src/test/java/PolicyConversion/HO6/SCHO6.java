...
public class SCHO6 extends BaseTest
{
	...
	@Test(dataProviderClass = AccountPolicyGenerator.class, dataProvider = "SCHO6Data",groups = "Renewal Test")
	public void RenewalLoadTest2(LinkedHashMap<String, String> eai, ArrayList<LinkedHashMap<String, String>> addInts, ArrayList<LinkedHashMap<String, String>> spp)
	{
		...
		createAccount
			...
			SCHO6AccountFileSummary accountFileSummary = createAccount
		...
		accountFileSummary = new SCHO6AccountFileSummary(sh);
		accountFileSummary.westPanel.actions.convertManualPolicy();
		SCHO6InitiateManualRenewal imr = new SCHO6InitiateManualRenewal(sh);
...
//			imr.clickExcludedLossOfUseCoverage("false");
		SCHO6Offerings offerings = imr.nextAndAccept();

		// Offerings
		offerings
		.setPolicyType(eai.getOrDefault("Policy Type", null))
		.setOfferingSelection(eai.getOrDefault("Offering Selection","Most Popular"));
		SCHO6PolicyInfo pi = offerings.next();
...
//		System.out.println();
		...
		{
			SCHO6RenewalBound rb = quote.renew();
