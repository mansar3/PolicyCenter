...
//
//        NCHO3NavigationBar nb = new NCHO3NavigationBar(sh);
//        NCHO3SearchAccounts sa = nb.clickSearchAccount();
//        NCHO3AccountFileSummary afs = sa.setFirstName(firstname)
//                .setLastName(lastname)
//                .clickSearchButton()
...
//        NCHO3Qualification qualification = ns.productTable.selectHomeowners();
...
//        }
//
//        NCHO3Dwelling dwelling = qualification
//                .next()
//                .next()
//                .editLocation()
//                .setCounty(county)
...
//
//        NCHO3Coverages coverages = dwelling.next()
//                .clickWindMitigation()
...
//        NCHO3Coverages.NCHO3PropertyEndorsements pe = coverages.clickPropertyEndorsements();
//
