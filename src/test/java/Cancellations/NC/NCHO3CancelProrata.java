...
// */
//public class NCHO3CancelProrata extends BaseTest {
//
...
//    public void createPersonAccountAndIssueQuoteNCHO3(ITestContext itc) {
//
...
//
//        enterAccountInformation = new NCHO3EnterAccountInformation(sh);
//        //new NCHO3Coverages(sh, CenterPanelBase.Path.POLICYRENEWAL).setPersonalPropertyLimit("fasdf").setOtherStructuresPercentage("afda").clickPropertyEndorsements().
//        enterAccountInformation
//                .setFirstName(firstname)
//                .setLastName(lastname)
//                .setCountry(country);
//
//        NCHO3CreateAccount createAccount = enterAccountInformation.createNewPersonAccountNCHO3();
...
//
//
//        NCHO3Coverages coverages = dwe.next()
...
//    }
//
//    @Test    (dependsOnMethods =  {"createPersonAccountAndIssueQuoteNCHO3"})
...
//        String insuredDiffEffectiveDate1 = "120";
//
//
//        //verifies the diffrence between the date
//
//        Assert.assertEquals(insuredCanEffectiveDate1, insuredDiffEffectiveDate1, "The Cancellation effective date diffrence should be 120 days and it is not");
//
//
//        //verify the cancellation is manditory or not
//
