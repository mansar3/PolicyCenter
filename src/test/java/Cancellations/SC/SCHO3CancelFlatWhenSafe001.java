 ...
 */
public class SCHO3CancelFlatWhenSafe001 extends BaseTest {
        ...
        public void createPersonAccountAndIssueQuoteSCHO3(ITestContext itc) {
            ...
            SCHO3PolicyInfo pi = qua.next();
            SCHO3Dwelling dwe = pi.next()
            ...
            SCHO3Coverages coverages = dwe.next()
            ...
            SCHO3RiskAnalysis ra = coverages.next();
            ra.clickPriorLosses();
        ...
        @Test   // (dependsOnMethods =  {"createPersonAccountAndIssueQuoteSCHO3"})
...
//                "Reason Description was not expected to be a required field");
            ...
            Assert.assertTrue(cancelDescription.equals(expectedcanceldescription), "In the Description Form# FIM-CXB and Edition 1/14 (Notice Of Cancellation) should be present but it is not");


            //clicks on summary tab
           ...
           // Assert.assertTrue(expectedwhensafescheducan.equals(whensafescheducan), "In When safe policy  The Pending Scheduled Cancellation should pop up at the top of the screen but it was not.");
            ...
            String cancelDescription1 =  forms.getnoticeofcancellationdescription();

            //verifies the notice of cancellation decription
            Assert.assertTrue(cancelDescription1.equals(expectedcanceldescription), "In the Description Form# FIM-CXB and Edition 01/14 (Notice Of Cancellation) should be present but it is not");
