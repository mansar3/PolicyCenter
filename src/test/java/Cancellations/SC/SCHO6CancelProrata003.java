 ...
 */
public class SCHO6CancelProrata003 extends BaseTest {
    ...
    public void createPersonAccountAndIssueQuoteSCHO6(ITestContext itc) {
        ...
        //new SCHO6Coverages(sh, CenterPanelBase.Path.POLICYRENEWAL).setPersonalPropertyLimit("fasdf").setOtherStructuresPercentage("afda").clickPropertyEndorsements().
...
//                .underContractWithRentalManagementCompany(undercontract);
        ...
        SCHO6Coverages coverages = dwe.next()
//                .setValuationType(valuation)
        ...
        SCHO6RiskAnalysis ra = coverages.next();
        ra.clickPriorLosses();
    ...
    @Test   // (dependsOnMethods =  {"createPersonAccountAndIssueQuoteSCHO6"})
